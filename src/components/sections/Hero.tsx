        ...
        <div className="grid grid-cols-1 justify-center md:grid-cols-2 md:p-16 lg:p-4">
          <div className="flex flex-col text-center w-full justify-center px-4 gap-4">
            ...
            <h2 className="font-poppins text-3xl md:text-3xl font-bold lg:text-4xl pb-2">
              FullStack{" "}
              <span
                className="text-green-600 pt-5"
                style={{ color: "#B7990D" }}
              >
                Developer
              </span>
            </h2>
            <p className="lg:text-xl pt-4" style={{ color: "#F2F4CB" }}>
            ...
            <div className="flex justify-center pt-3.5 gap-4 pb-10 md:flex-row md:justify-center">
              <Button
                ...
                sx={{
                  ...
                  color: "#000000",
                  minWidth: 100, // asegura ancho
                  minHeight: 44, // asegura área clicable
                  padding: "12px 24px", // da aire
                  borderRadius: "12px",
                  fontSize: "1rem",
                  fontWeight: 600,
                  "&:hover": {
                    backgroundColor: "#e5e7b8",
                  },
                }}
                component="a"
